 ...
 * @returns {AccountConnectionModel} Returns the AccountConnectionModel passed as param `data` or a new created AccountConnectionModel.
 */
AccountConnectionModel.createFromUserProfile = function(appId, profile, scope) {
	var data = UserProfile.convertToAccountConnection(profile);
	data.appId = appId;
	return AccountConnectionModel.create(data, scope);
};
 ...
 * @function
 */
AccountConnectionModel.formatId = formatId;
