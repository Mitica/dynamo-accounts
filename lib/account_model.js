 ...
 * @returns {AccountModel} Returns the AccountModel passed as param `data` or a new created AccountModel.
 */
AccountModel.createFromUserProfile = function(appId, profile, scope) {
	var data = UserProfile.convertToAccount(profile);
	data.appId = appId;
	return AccountModel.create(data, scope);
};

/**
 * @function
 */
AccountModel.generateUsername = generateUsername;

/**
 * @function
 */
AccountModel.normalizeUsername = normalizeUsername;
