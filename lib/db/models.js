...
var AccountConnectionRecord = require('./account_connection_record');
var AccountRecord = require('./account_record');
...
vogelsHelpers.define('Account', Account, AccountRecord.config);
vogelsHelpers.define('AccountConnection', AccountConnection, AccountConnectionRecord.config);
